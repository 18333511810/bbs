                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:120px;text-align: left">
                        <select name="fid">
                            ...
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if( $v["pid"] == 0 ): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
            ...
            <table class="layui-table">
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tbody id="x-link">
                    <tr>
                        ...
                        <td>
                            <?php echo (str_repeat("&emsp;&nbsp;",$v["level"])); echo ($v['level']+1); ?>.<?php echo ($v["name"]); ?>
                        </td>
                        <td class="td-manage">
                            <a title="编辑" href="javascript:;" onclick="cate_edit('编辑','/index.php/Admin/Category/edit/id/<?php echo ($v["id"]); ?>','4','','510')"
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a title="删除" href="javascript:;" onclick="cate_del(this,'<?php echo ($v["id"]); ?>')" 
