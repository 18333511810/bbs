...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/Public/Admin/lib/bootstrap/css/bootstrap.css" media="all">
        <link rel="stylesheet" href="/Public/Admin/lib/bootstrap/js/bootstrap.min.js" media="all">
    </head>
    <body>
    <style type="text/css">
	...
	.layui-table{ font-family: "Microsoft YaHei","Helvetica Neue";}
        ...
        <div class="x-body">
            <blockquote class="layui-elem-quote">
                欢迎使用论坛管理系统！<span class="f-14">v1.0</span> &nbsp;&nbsp;登录次数：18 
            </blockquote>
<div class="row">
            ...
            <div class="col-xs-6 col-sm-4 col-md-3">
                <section class="panel">
                    ...
                    <div class="value tab-menu" bind="1">
                        ...
                        <a href="javascript:;" data-url="user-info.html" data-parent="true" data-title="订单总数"> <i class="iconfont " data-icon=""></i><span>文章总数</span></a>
                    </div>
                </section>
            </div>
            ...
            <fieldset class="layui-elem-field layui-field-title site-title">
              <legend><a name="default">会员统计</a></legend>
            </fieldset>
        ...
        <script src="/Public/Admin/js/echart.js"></script>
